...
class UserController extends Controller{
    public function index(){
        ...
        $this->content=$this->render('views/user/index.php',[
            'users'=>$users,
            'pages'=>$pages
        ]);
    ...
    public function create(){
        ...
        if (isset($_POST['submit'])) {
            ...
            if (empty($this->error)) {
                ...
                if ($_FILES['avatar']['error'] == 0) {
                    $dir_uploads = __DIR__ . '/../assets/upload_avatar';
        ...
        $this->content = $this->render('views/user/create.php');
    ...
    public function update(){
        ...
        $this->content=$this->render('views/user/update.php',
            [
                'user'=>$user
            ]);
        require_once 'views/layouts/main.php';
    ...
    public function detail(){
        ...
        $this->content = $this->render('views/user/detail.php', [
            'user' => $user
        ]);
