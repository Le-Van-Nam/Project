...
//        $categories = $category_model->getAll();
      $this->content=$this->render('views/product/index.php',[
          'products' => $products,
          'pages' => $pages,
      ]);
    ...
    public function create(){
        ...
        //lấy danh sách danh mục phục vụ cho quản lý product
        $category_model = new Category();
        $categories = $category_model->getAll();

        $this->content = $this->render('views/product/create.php',['categories' => $categories]);
        require_once 'views/layouts/main.php';
