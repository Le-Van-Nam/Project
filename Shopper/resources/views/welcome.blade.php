            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="{{URL::to('trang-chu')}}"><img src="{{('public/frontend/images/logob.png')}}" alt="" /></a>
                    </div>
                    ...
                    <div class="brands_products"><!--brands_products-->
                        ...
                        <div class="brands-name">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="{{URL::to('brand-san-pham/'.$value->brand_id)}}"><span class="pull-right">(50)</span>{{$value->brand_name}}</a></li>
                            @endforeach
                        </div>
                    </div><!--/brands_products-->
                </div>
